...
import com.wanmi.sbc.order.bean.dto.yzorder.deliver.DeliverOrderItemDTO;
import com.wanmi.sbc.order.bean.dto.yzorder.deliver.DistOrderDTO;
...
public class YzOrderDeliver {
     ...
     * 货单明细
     */
    private List<DeliverOrderItem> delivery_order_items;

    /**
     * 配送单
     */
    private List<DistOrder> dist_order_d_t_os;
