 ...
 */
public class CustomerTagWhereCriteriaBuilder {
    public static Specification<CustomerTag> build(CustomerTagQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            // 会员人数
            if (queryRequest.getCustomerNum() != null) {
                predicates.add(cbuild.equal(root.get("customerNum"), queryRequest.getCustomerNum()));
            }
