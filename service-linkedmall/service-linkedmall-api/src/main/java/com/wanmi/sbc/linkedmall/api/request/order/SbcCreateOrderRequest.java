...
@Builder
@ApiModel
public class SbcCreateOrderRequest implements Serializable {

    @ApiModelProperty(value = "商品信息,itemId：spuId; quantity:购买数量; skuId: skuId")
    @NotEmpty
    private List<CreateOrderV2Request.ItemList> lmGoodsItems;
    ...
    @ApiModelProperty(value = "订单失效时间，单位秒，默认15分钟")
