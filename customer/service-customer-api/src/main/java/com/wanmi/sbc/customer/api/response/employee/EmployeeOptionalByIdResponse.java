...
@ApiModel
@Data
public class EmployeeOptionalByIdResponse implements Serializable {

    private static final long serialVersionUID = -7805049834255215660L;
