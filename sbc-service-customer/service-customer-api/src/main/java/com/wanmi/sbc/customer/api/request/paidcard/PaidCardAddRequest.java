...
@NoArgsConstructor
@AllArgsConstructor
public class PaidCardAddRequest extends CustomerBaseRequest {
	...
	private List<PaidCardRuleAddRequest> ruleList;

	/**
	 * 会员权益列表
	 */
	@ApiModelProperty(value = "前景色")
	private List<PaidCardRightsRelAddRequest> rightsList;
