...
public interface GoodsInfoRepository extends JpaRepository<GoodsInfo, String>, JpaSpecificationExecutor<GoodsInfo> {
    ...
    @Query(value = "select new com.wanmi.sbc.goods.info.model.entity.GoodsStockInfo(g.goodsInfoId, g.goodsId, g.erpGoodsNo,g.costPrice,g.costPriceSyncFlag,g.goodsInfoName,g.goodsInfoNo,g.marketPrice) " +
