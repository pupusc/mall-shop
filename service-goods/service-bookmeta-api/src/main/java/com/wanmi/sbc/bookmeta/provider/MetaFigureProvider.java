...
public interface MetaFigureProvider {
     ...
     * @return 是否成功
     */
    @PostMapping("/goods/${application.goods.version}/metaFigure/listFigureRecomdById")
    BusinessResponse<List<MetaBookRcmmdFigureBO>> listFigureRecomdById(@RequestParam(value = "spuId")String spuId,@RequestParam(value = "skuId") String skuId);
}
