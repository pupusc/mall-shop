...
import com.aliyuncs.linkedmall.model.v20180116.RenderOrderRequest;
...
@Builder
@ApiModel
public class SbcRenderOrderRequest implements Serializable {

    @ApiModelProperty(value = "商品信息")
    @NotEmpty
    private List<RenderOrderRequest.ItemList> lmGoodsItems;
