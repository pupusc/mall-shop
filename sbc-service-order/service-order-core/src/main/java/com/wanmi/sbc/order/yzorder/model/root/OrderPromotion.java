...
public class OrderPromotion implements Serializable {
     ...
     * 商品级优惠明细
     */
    private List<OrderPromotionItem> item;

    /**
     * 订单级优惠明细
     */
    private List<OrderPromotionOrder> order;

    private List<OrderPaidPromotion> order_paid_promotion;

    /**
     * 邮费优惠信息
     */
    private List<PostFee> post_fee;
}
