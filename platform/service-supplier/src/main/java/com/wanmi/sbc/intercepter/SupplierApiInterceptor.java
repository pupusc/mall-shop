 ...
 */
public class SupplierApiInterceptor implements HandlerInterceptor {

    public SupplierApiInterceptor() {
    }

    public SupplierApiInterceptor(String jwtExcludedRestUrls, String apiExcludedRestUrls) {
