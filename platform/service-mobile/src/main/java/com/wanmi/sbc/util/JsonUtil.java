...
public class JsonUtil {
    ...
    //丰富
    public static void richJson(Object jsonObject, String key, Map richMap) {
    ...
    public static void main(String[] args) {
        ...
        Gson gson = new Gson();
        //Map<String, List> map = gson.fromJson(json,new TypeToken<Map<String,List>>(){}.getType());
        Type type = new TypeToken<Map<String, Object>>() {}.getType();
        Map<String, Object> gsonMap = gson.fromJson(json, type);

        //输出测试

        String jsonString1 = gson.toJson(gsonMap);
        ...
        JsonUtil.richJson(gsonMap,"sku_id",map);

        String jsonString2 = gson.toJson(gsonMap);
