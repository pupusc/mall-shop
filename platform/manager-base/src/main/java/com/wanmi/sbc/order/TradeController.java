...
//    }
    ...
    @RequestMapping(value = "/erpGoods/syncDeliveryStatus/{orderId}", method = RequestMethod.GET)
    public BaseResponse syncDeliveryStatus(@PathVariable("orderId") String orderId){
        ProviderTradeErpRequest request = new ProviderTradeErpRequest();
        request.setOrderId(orderId);
        providerTradeQueryProvider.batchSyncDeliveryStatus(request);
        return BaseResponse.SUCCESSFUL();
    }
}
