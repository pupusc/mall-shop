...
public abstract class UmengNotification {
	...
	protected static final HashSet<String> ROOT_KEYS = new HashSet<String>(Arrays.asList("appkey", "timestamp", "type",
	...
	protected static final HashSet<String> POLICY_KEYS = new HashSet<String>(Arrays.asList("start_time", "expire_time",
			"max_send_num","out_biz_no"));
    ...
    public void setOutBizNo(String no) throws Exception {
		setPredefinedKeyValue("out_biz_no", no);
	}
	...
	public void setMiactivity(String activity) throws Exception {
