...
@NoArgsConstructor
@AllArgsConstructor
public class AppointmentSaleGoodsQueryRequest extends BaseQueryRequest {
     ...
     */
    @ApiModelProperty(value = "批量查询-goodsInfoIdList")
    private List<String> goodsInfoIdList;

    /**
     * 批量查询-appointmentSaleIdList
     */
    @ApiModelProperty(value = "批量查询-appointmentSaleIdList")
    private List<Long> appointmentSaleIdList;
