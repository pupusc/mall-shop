...
@Data
@ApiModel
public class EsSettlementSearchResponse implements Serializable {
    public static final Logger LOGGER = LoggerFactory.getLogger(EsSettlementSearchResponse.class);
     ...
     * @return
     */
    public EsSettlementSearchResponse addTotalNum(SearchResponse response) {
     ...
     * @return
     */
    private EsSettlementSearchResponse addQueryResults(SearchResponse response, ResultsMapper resultsMapper) {
     ...
     * @return
     */
    public static EsSettlementSearchResponse empty() {
        EsSettlementSearchResponse response = new EsSettlementSearchResponse();
     ...
     * @return
     */
    public static EsSettlementSearchResponse build(SearchResponse searchResponse, ResultsMapper resultsMapper) {
        return new EsSettlementSearchResponse().addQueryResults(searchResponse, resultsMapper).addTotalNum(searchResponse);
    }
