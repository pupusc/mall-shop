...
public class EsBookListModelService {
    ...
    private BoolQueryBuilder packageKeyWordQueryCondition(EsKeyWordBookListQueryProviderReq esKeyWordQueryProviderReq) {
        ...
        boolQb.should().add(matchQuery(ConstantMultiMatchField.FIELD_BOOK_LIST_BOOKLISTNAME, esKeyWordQueryProviderReq.getKeyword()).minimumShouldMatch(ConstantMultiMatchField.FIELD_MINIMUM_SHOULD_MATCH));
        boolQb.should().add(nestedQuery("spus", matchQuery(ConstantMultiMatchField.FIELD_BOOK_LIST_SPU_SPUNAME, esKeyWordQueryProviderReq.getKeyword()).minimumShouldMatch(ConstantMultiMatchField.FIELD_MINIMUM_SHOULD_MATCH), ScoreMode.None));
        boolQb.should().add(nestedQuery("spus", matchQuery(ConstantMultiMatchField.FIELD_BOOK_LIST_SPU_SPUNAME_KEYWORD, esKeyWordQueryProviderReq.getKeyword()).minimumShouldMatch(ConstantMultiMatchField.FIELD_MINIMUM_SHOULD_MATCH), ScoreMode.None));
